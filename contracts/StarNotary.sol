...
contract StarNotary is ERC721 {
	constructor() ERC721("UdacityCoin", "UDC") {}
	event MyLog(address message0, address message, uint indexed someNumber); // TODO: REMOVE
    ...
    function buyStar(uint256 _tokenId) public  payable {
		...
		emit MyLog(ownerAddress, msg.sender, _tokenId); // TODO: REMOVE

        _transfer(ownerAddress, msg.sender, _tokenId); // We can't use _addTokenTo or_removeTokenFrom functions, now we have to use safeTransferFrom
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
		...
		// check suffices that msg.sender is participant
		require(msg.sender == ownerAddress1 || msg.sender == ownerAddress2);
        //4. Use safeTransferFrom function to exchange the tokens.
